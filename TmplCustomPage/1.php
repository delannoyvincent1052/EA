...
<!DOCTYPE html>
	...
	<body>
		<div id="LoggedUser" style="visibility: hidden"><?php echo $WorkerEmail ?></div><div style="visibility: hidden" id="UserSession"><?php echo $WorkerSession ?></div>
